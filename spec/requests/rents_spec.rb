...
RSpec.describe "/rents", type: :request do
  ...
  describe "POST /create" do
    context "with valid parameters" do
      ...
      it "redirects to the created rent" do
        post rents_url, params: { rent: valid_attributes }
        expect(response).to redirect_to(rent_url(Rent.last))
      end
    end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "redirects to the rent" do
        ...
        patch rent_url(rent), params: { rent: new_attributes }
        rent.reload
        expect(response).to redirect_to(rent_url(rent))
      end
    end
  ...
  describe "DELETE /destroy" do
    ...
    it "redirects to the rents list" do
      rent = Rent.create! valid_attributes
      delete rent_url(rent)
      expect(response).to redirect_to(rents_url)
    end
  end
end
